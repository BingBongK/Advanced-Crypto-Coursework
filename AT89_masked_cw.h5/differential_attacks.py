...
def byte_correlation(inputs, traces):
    ...
    for key_guess in range(256):
        ...
        pred_leak = sim.HW8[np.bitwise_not(ark, sb)]
        chunksize = 50
...
if __name__ == '__main__':
    ...
    f = h5py.File("AT89_masked_cw.h5", "r")
    ...
    windows = [
        (200, 380), (380, 460), (460, 540), (540, 620),
        (620, 700), (700, 780), (780, 860), (860, 940),
        (940, 1020), (1020, 1100), (1100, 1180), (1180, 1260),
        (1260, 1340), (1340, 1420), (1420, 1500), (1500, 1580)
    ]
    ...
    for b in range(16):
        ...
        dist = byte_correlation(
            inputs[:, b],
            traces[:, start:end]
        )

        key_guess = np.unravel_index(
            np.argmax(np.abs(dist)), dist.shape
        )[0]

        key.append(key_guess)
    for i in key:
        print("Recovered key:", i)